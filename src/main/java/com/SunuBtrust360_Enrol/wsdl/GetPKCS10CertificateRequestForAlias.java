...
/**
 * <p>Classe Java pour getPKCS10CertificateRequestForAlias complex type.
 * 
 * <p>Le fragment de schma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="getPKCS10CertificateRequestForAlias"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "getPKCS10CertificateRequestForAlias", propOrder = {
    "signerId",
    "certReqInfo",
    "explicitEccParameters",
    "keyAlias"
})
public class GetPKCS10CertificateRequestForAlias {
    ...
    /**
     * Obtient la valeur de la propri�t� keyAlias.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * D�finit la valeur de la propri�t� keyAlias.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
