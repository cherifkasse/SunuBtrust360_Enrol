...
@XmlType(name = "removeAuthorizedClient", propOrder = {
    "workerId",
    "authClient"
})
public class RemoveAuthorizedClient {
    ...
    /**
     * Obtient la valeur de la propri�t� authClient.
     * 
     * @return
     *     possible object is
    ...
    /**
     * D�finit la valeur de la propri�t� authClient.
     * 
     * @param value
     *     allowed object is
     *     {@link AuthorizedClient }
