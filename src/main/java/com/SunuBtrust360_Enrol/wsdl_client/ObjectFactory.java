 ...
 * generated in the org.signserver.clientws package. 
...
public class ObjectFactory {
    ...
    private final static QName _ProcessDataData_QNAME = new QName("", "data");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.signserver.clientws
     * 
     */
     ...
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link ProcessData }{@code >}
     */
     ...
     *     Java instance representing xml element's value.
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link ProcessDataResponse }{@code >}
     */
     ...
     *     Java instance representing xml element's value.
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link ProcessSOD }{@code >}
     */
     ...
     *     Java instance representing xml element's value.
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link ProcessSODResponse }{@code >}
     */
     ...
     *     Java instance representing xml element's value.
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link RequestFailedException }{@code >}
     */
     ...
     */
    @XmlElementDecl(namespace = "", name = "data", scope = ProcessData.class)
    public JAXBElement<byte[]> createProcessDataData(byte[] value) {
        return new JAXBElement<byte[]>(_ProcessDataData_QNAME, byte[].class, ProcessData.class, ((byte[]) value));
    }
